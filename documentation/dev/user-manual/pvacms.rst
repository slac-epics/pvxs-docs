...
||                                              || e.g. ``~/.config/pva/1.5/admin.p12``      || append the password after a semicolon, e.g. ``admin.p12;password``.     |
+-----------------------------------------------+--------------------------------------------+--------------------------------------------------------------------------+
...
||                                              || ``~/.config/pva/1.5/cert_auth.p12``       || password after a semicolon, e.g. ``cert_auth.p12;password``.            |
+-----------------------------------------------+--------------------------------------------+--------------------------------------------------------------------------+
...
||                                              || e.g. ``~/.config/pva/1.5/pvacms.p12``     || password after a semicolon, e.g. ``pvacms.p12;password``.               |
+-----------------------------------------------+--------------------------------------------+--------------------------------------------------------------------------+
